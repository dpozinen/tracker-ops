                    ...
                    <div class="row mb-3">
                        <div class="col-4">
                            <h6 class="card-subtitle mb-2 text-muted t-size">
                                <i class="fa-solid fa-arrow-down"></i>${torrent.downloadSpeed}</h6>
                        </div>
                        <div class="col-4">
                            <h6 class="card-subtitle mb-2 text-muted t-size">
                                <i class="fa-solid fa-clock"></i>${torrent.eta}</h6>
                        </div>
                        <div class="col-4">
                            <h6 class="card-subtitle mb-2 text-muted t-size">
                                <i class="fa-solid fa-arrow-up"></i>${torrent.uploadSpeed}</h6>
                        </div>
                    </div>
